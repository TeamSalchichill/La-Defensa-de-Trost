...
* 4.**Mundos** 
  ...
  * 4.5. Valhalla
  * 4.6. Selva Mágica
  * 4.7. Trost sumido en el Infierno
...
* 6.**Héroes** 
  ...
  * 6.5. Valhalla
  * 6.6. Selva mágica
  * 6.7. Trost sumido en el infierno
* 7.**Torretas**
  * 7.1. Tutyn y general
  * 7.2. Winterfall
  * 7.3. Farafra
...
* 8.**Enemigos** 
  ...
  * 8.5. Valhalla
  * 8.6. Selva mágica
  * 8.7. Trost sumido en el infierno
  * 8.8. Enemigo final del juego
* 9.**Arte 2D** 
  * 9.1. HUD
  * 9.2. Pantallas
...
* 13.**Plan de marketing** 
  * 13.1. Pre-Lanzamiento del videojuego
  * 13.2. Post-Lanzamiento del videojuego
* 14.**Propósito, público objetivo y plataformas** 
  * 14.1. Propósito
  * 14.2. Público objetivo
  * 14.3. Plataformas
* 15.**Hitos**
  * 15.1. Hito 1 - Versión Alpha
  * 15.2. Hito 2 - Versión Beta
  * 15.3. Hito 3 - Versión Gold Master
  * 15.4. Hito 4 - Publicación
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/Diagrama sin título.drawio.png" alt="JuveR" width="500px">
</p>  

Registro: En esta pantalla el jugador podrá registrarse con su nombre y una contraseña para guardar su progreso en el videojuego, ya que han de ir desbloqueando todos los mundos de forma sucesiva y de esta forma podrán guardar su avance.
...
Wiki: En esta pantalla podemos encontrar información sobre todos los elementos del videojuego según se van descubriendo los diferentes mundos al jugarlos y completarlos.
...
Ajustes modo de juego infinito: Esta pantalla se muestra si hemos seleccionado el modo de juego infinito, en ella se debe elegir un mundo en el que jugar, un hechizo, un héroe y 6 torretas.
...
Fin de partida: Pantalla de fin de partida, esta aparece cuando terminamos la partida, es decir el jugador ha sido derrotado, el jugador ha ganado o ha decidido finalizar la partida antes de terminar.
...
# 4.**Mundos** 
Existen 6 mundos diferentes, además de un mundo aparte que sirve como tutorial e introducción al videojuego. En cada mundo hay un terreno diferente, y cada mundo tienes unas características únicas, diferentes enemigos, torretas, hechizos o reglas.

  ## 4.1. Turyn
En este mundo existen casillas especiales si están colocadas en el mapa, las cuales al colocar una torreta sobre ellas otorga mayor fuerza de ataque.

<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/suelo1.PNG" alt="JuveR" width="300px">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/suelo2.PNG" alt="JuveR" width="300px">
</p> 

En el caso del camino, sólo existe un tipo de casilla el cual no otorga ningún tipo de efecto o bonificación sobre enemigos o aliados.

<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/camino1.PNG" alt="JuveR" width="300px">
</p> 
...
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/image.png" alt="JuveR" width="300px">
</p>  
...
Cada mundo tiene una torre principal que lo caracteriza, así como un hechizo propio. A continuación, se explican las diferentes torres principales y hechizos.
  ...
  ## 5.1. Turyn
La torre principal de Turyn es un castillo medieval donde se encuentran todos los secretos que alberga el tesoro de Trost, y consecuencias de que pasaría si acaba en las manos equivocadas.

<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/Turyn.png" alt="JuveR" width="300px">
</p>  
...
# 6.**Héroes** 
  ## 6.1. Turyn
Rey Dante: El rey Dante es un fanático de los libros medievales, tal es su afán por ellos que ha logrado un manejo perfecto de la espada para defender su reino.

Ataque normal: ataque en área con un rango fuera de lo común para acabar con todos los enemigos de una forma sencilla y poco común.

<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil1.png" alt="JuveR" width="300px">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/rey_dante.png" alt="JuveR" width="300px">
</p> 
...
o	Caballero Gulev: El Caballero Gulev es el mayor enemigo del Rey Dante, debido odio que este le tiene, ha formado un ejército de valientes caballeros para derrocar al rey y así quedarse con la corona.

<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-08T160429.824.png" width="300px">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/Gulev.png" width="300px">
</p>  

**Enemigo Mediano**

o	Akca: Líder de los guerreros de Gulev, con el manejo de su gran hacha busca liderar a los espadachines hacia la victoria.

<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-08T161603.354.png" width="300px">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/akca.png" width="300px">
</p>  

**Enemigo Pequeño**

o	Yucel: Yucel es un espadachín a cargo del caballero Gulev, presenta un gran manejo de la espada con el que busca derrotar a Dante.

<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-08T161142.893.png" width="300px">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/yucel.png" width="300px">
</p> 
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (86).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (81).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (80).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (79).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (78).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (77).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (92).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (90).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (91).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (87).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (88).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (89).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (98).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (97).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (96).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (95).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (93).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (94).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T001632.780.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T000147.062.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-03T235351.836.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (100).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-03T234143.079.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 (99).png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T015431.968.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T013602.876.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T014404.802.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T002622.577.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T004150.114.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T003257.934.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T023012.915.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T023918.153.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T024439.830.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T020705.242.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T024733.107.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/pixil-frame-0 - 2022-12-04T021615.389.png" width="300px">
...
<p align="center">
<img src="https://github.com/TeamSalchichill/La-Defensa-de-Trost/blob/main/ImagenesGDD/hud.PNG" width="700px">
</p>  
...
# 13.**Plan de marketing** 
  ## 13.1. Pre-Lanzamiento del videojuego
El marketing de la Defensa de Trost tiene su pilar fundamental en las redes sociales, mediante la realización de publicaciones diarias durante la mayor parte del tiempo que el juego ha estado en desarrollo, comenzando a dar a conocer la existencia del juego el día 2 de octubre de 2022. Las redes donde se ha presentado el videojuego son: Twitter, YouTube, Instagram y Tik Tok.
...
- Publicación del enlace al videojuego en todas las redes sociales de las que posee el videojuego, acompañado de un sorteo de una cuenta que proporciona acceso exclusivo a contenidos del videojuego para facilitar la difusión de la noticia.

- Realización de publicaciones en redes sociales mostrando elementos nunca mostrados antes por redes para incitar a jugarlo. Durante la semana posterior al lanzamiento del juego se irán publicando video-gameplays del juego, memes a través de los personajes del juego, contenidos añadidos fuera de los niveles y contenido acerca de la historia que se desarrolla en el videojuego.

- Una campaña de difusión del juego en el transporte público, sabemos que una parte del público objetivo son personas que dispongan de un tiempo libre, teniendo esto en cuenta, se ha ideado la promoción del juego mediante carteles con códigos QR en estaciones de autobuses y paradas de metro para amenizar la espera a las personas y llegar a más público.
